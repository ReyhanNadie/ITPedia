...
public class Kuis2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mrgPilihanJawaban = (RadioGroup) findViewById(R.id.mrgPilihanJawaban);
        mrbPilihanJawaban1 = (RadioButton)  findViewById(R.id.pil1);
        mrbPilihanJawaban2 = (RadioButton) findViewById(R.id.pil2);
        mrbPilihanJawaban3 =(RadioButton)findViewById(R.id.pil3);
        mrbPilihanJawaban4 = (RadioButton)findViewById(R.id.pil4);
        mbtnSubmit = (Button) findViewById(R.id.next);
    ...
    public void setKonten(){
        ...
        if(x >= arr){ //jika nilai x melebihi nilai arr(panjang array) maka akan pindah activity (kuis selesai)
            ...
            Intent i = new Intent(Kuis2.this, Score.class);
